 ...
 // overlay
  ...
  <div className="topnav" id="myTopnav">
    ...
    <div className="menu">
      ...
      <div className="dropdown">
        ...
        <div className="dropdown-content">
          <ul>Men
            <li><a href="product.html?brand=Versace">Versace</a></li>
            <li><a href="product.html?brand=Hugo Boss">Hugo Boss</a></li>
      ...
      <div className="menu-search">
        <div className="searchshow">
          ...
          <div key={product.id}>
            <h3>{product.title}</h3>
            <p>Price: {product.priceNew}</p>

      <img src={`${Image_URL}${product.imageSrc}`} alt={product.title} width={100}/>
      <button onClick={() => handleProductClick(product,product.id)}>View</button>
    ...
    <div key={index}>
      ...
      <button  onClick={() => handleProductClick(item,index)}>View</button>
  ...
  <img src={`${Image_URL}${item.imageSrc}`} alt={item.productName} width={100}/>
      ...
      <button onClick={() => deleteProductCart(item.productName)}>Delete</button>
    </div>
  ))}
</div>
        ...
        <div className="settingshow">
          ...
          <div className="setting-products">
            ...
            <p>{phone} </p>
            {authenticated ? (
            <div className="logout"><h3><button onClick={handleLogout}>Log out</button></h3></div>
          ) : (
